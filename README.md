...
- `configs/dashboard-test.json`: definition for the authorized `192.168.1.81` / `dashboard-test` test; the 2026-09-03 run confirmed
  HTTP/80 with base path `/`, so that service is enabled while HTTPS/443 remains disabled. Its `dashboard_session` credential can reuse
